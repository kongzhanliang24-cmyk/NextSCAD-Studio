...
from src.parts.accessories.barcode_scanner import make_barcode_scanner
...
def main() -> None:
    ...
    print("[BUILD] 正在構建 barcode scanner assembly ...")
    assy = make_barcode_scanner()
    ...
    print(f"[DONE] 掃碼槍 GLB 已輸出 ({size_kb:.1f} KB): {out_path}")
