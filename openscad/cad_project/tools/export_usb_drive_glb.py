...
from src.parts.accessories.usb_flash_drive import make_usb_flash_drive
...
def main() -> None:
    ...
    print("[BUILD] 正在構建 USB flash drive assembly ...")
    assy = make_usb_flash_drive()
    ...
    print(f"[DONE] 隨身碟 GLB 已輸出 ({size_kb:.1f} KB): {out_path}")
